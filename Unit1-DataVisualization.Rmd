...
Here's an article discussing some of the main innovations and innovators in early data visualization: <https://towardsdatascience.com/a-short-history-of-data-visualisation-de2f81ed0b23>

While reading the article, think and write down your ideas for the following questions:

1. What does the article describe as some of the earliest types of data visualization? What other possible types of early data visualization can you think of?

2. Who were three of the early pioneers of data visualization? What set their styles apart?

3. What innovation led to the rise of spreadsheets and automated editing, formatting, and updating of tables?
...
<!-- I'm trying to put these in two columns, but it needs a bit more finagling!  -->

<div class="columns-2">

```{r, out.width = "30%", out.height = "110%"}
knitr::include_graphics("pic_webdubois.jpeg")
```
...
```{r, out.width = "30%"}
knitr::include_graphics("web_visualization.jpg")
```

</div> 

W. E. B. Du Bois, the American sociologist, historian, civil rights activist, and $\ldots$ data visualization practitioner? [Image Credit](https://en.wikipedia.org/wiki/W._E._B._Du_Bois) Read the article below about Du Bois' work and pick your favorite infographic of his. Why does it appeal to you? What are some things you notice?
