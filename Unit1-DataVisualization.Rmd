...
This Unit contains 4 lesson modules: Introduction, The Context of Data, Think Outside the Box, and Applying the Tools. You will learn the history of data visualization, how to imagine new ways of the genre, and apply your new skills to your own life.
...
Read the article below about Du Bois' work and pick your favorite infographic of his. Why does it appeal to you? What are some things you notice?
...
Final sentence from the article: "Let the PR peeps do the "spinning" and data do the talking."
...
## (THIS WHOLE SECTION IS OLD, MIGHT DELETE) Physical Data Visualization
